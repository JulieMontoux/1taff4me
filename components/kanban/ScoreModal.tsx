...
import type { ApplicationFormData, ScoreResult } from '@/lib/types'
...
function Section({ title, items, color }: { title: string; items: string[]; color: 'green' | 'red' | 'blue' | 'orange' }) {
...
export function ScoreModal({ open, onClose, application }: Props) {
  ...
  function handleCvChange(e: React.ChangeEvent<HTMLTextAreaElement>) {
